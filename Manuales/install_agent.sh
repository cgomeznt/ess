...
fteCreateAgent -f -agentName SRVPRAGN.AG -agentQMgr SRVPRAGN -agentQMgrHost mq-server -agentQMgrPort 1418 -agentQMgrChannel SYSTEM.DEF.SVRCONN -agentDesc "Agent Principal SRVPRAGN"' > /usr/local/bin/config.sh
